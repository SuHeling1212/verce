...
public class sra32B {
    public static boolean[] module(boolean[] in, boolean[] shift) {
        boolean sign = in[31];
        boolean[] s0 = shift1(in, shift[0], sign);
        boolean[] s1 = shift2(s0, shift[1], sign);
        boolean[] s2 = shift4(s1, shift[2], sign);
        boolean[] s3 = shift8(s2, shift[3], sign);
        boolean[] s4 = shift16(s3, shift[4], sign);
        return s4;
    }

    private static boolean[] shift1(boolean[] in, boolean sel, boolean sign) {
    ...
    private static boolean[] shift2(boolean[] in, boolean sel, boolean sign) {
        boolean[] out = new boolean[32];
    ...
    private static boolean[] shift4(boolean[] in, boolean sel, boolean sign) {
        boolean[] out = new boolean[32];
    ...
    private static boolean[] shift8(boolean[] in, boolean sel, boolean sign) {
        boolean[] out = new boolean[32];
    ...
    private static boolean[] shift16(boolean[] in, boolean sel, boolean sign) {
        boolean[] out = new boolean[32];
