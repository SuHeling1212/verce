...
public class rightShifter32B {
    public static boolean[] srl(boolean[] in, boolean[] shift) {
    ...
    public static boolean[] sra(boolean[] in, boolean[] shift) {
        boolean sign = in[31];
        boolean[] s0 = shift1Sra(in, shift[0], sign);
        boolean[] s1 = shift2Sra(s0, shift[1], sign);
        boolean[] s2 = shift4Sra(s1, shift[2], sign);
        boolean[] s3 = shift8Sra(s2, shift[3], sign);
        boolean[] s4 = shift16Sra(s3, shift[4], sign);
        return s4;
    }
